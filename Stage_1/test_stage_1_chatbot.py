...
class TestChatbotE2E(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Assuming your executor_agent_chatbot accepts tools + memory
        ...
        chatbot_tools = [
            ...
            get_parking_information_tool, validate_reservation_tool,validate_cancellation_tool
        ]
    ...
    def test_estimate_price_p3(self):
        answer = self.ask_chatbot("Estimate price for Schiphol P3 Long Parking from 2026-04-14 09:15 to 2026-04-14 18:00.")
...
# --- Reservation Tests ---
    ...
    def test_availability_p1_short(self):
        answer = self.ask_chatbot("Is Schiphol P1 Short Parking available on April 1, 2026?")
        self.assertIn("499", answer)
    ...
    def test_parking_price_p1(self):
        answer = self.ask_chatbot("What is the price of P1 Short Parking?")
