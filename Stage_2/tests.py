...
from parking.agents.admin import agent_admin
from parking.agents.chatbot import agent_chatbot
from parking.database import get_connection
from parking.services.queries import auto_release_expired_reservations
from parking.tools.read import (
...
from parking.tools.write import validate_make_reservation_tool
from parking.tools.admin_checks import (
...
class TestMultiAgentE2E(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        chatbot_tools = [
            ...
            get_parking_information_tool, validate_make_reservation_tool, check_availability_tool
        ]
